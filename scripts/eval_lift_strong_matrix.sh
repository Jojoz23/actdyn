...
# Run a compact eval matrix for runs/actdyn_lift_strong and snapshot outputs.
# Usage:
#   ./scripts/eval_lift_strong_matrix.sh [CHECKPOINT] [CONFIG]
#
# Defaults:
...
CKPT="${1:-runs/actdyn_lift_strong/checkpoints/best.pt}"
CFG="${2:-configs/lift_lowdim_strong.yaml}"
TE_CFG="configs/lift_lowdim_strong_te_only.yaml"
RUN_DIR="runs/actdyn_lift_strong"
